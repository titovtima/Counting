...
//                    "\nСделано: " + Status.solved + "\nОшибок: " + Status.errors
    ...
    fun generateProblem(){
        ...
        b = 0
        when (Status.level){
            0 -> generateMultiplicationTableProblem()
            1 -> generateFirstLevelProblem()
            2 -> generateSecondLevelProblem()
            3 -> generateThirdLevelProblem()
            4 -> generateFourthLevelProblem()
        }
        when (action){
    ...
    fun generateSecondLevelProblem() {
...
//                        problem.text = a.toString() + " / " + b.toString()
    ...
    fun generateFourthLevelProblem() {
        action = (Math.random()*4).toInt()
    ...
    fun generateMultiplicationTableProblem() {
